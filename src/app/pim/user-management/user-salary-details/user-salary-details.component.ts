...
export class UserSalaryDetailsComponent implements OnInit {
  ...
  salaryData:any;
  resultData:any;
  bankRoutingMinLength;
  bankRoutingMaxLength;
  accountNumberMinlength;
  accountNumberMaxLength;
  constructor(private eventEmitterService: EventEmitterService,private route: ActivatedRoute, public http: Http, private router: Router, public auth: AuthenticationService, public service: UserService, private blocation: Location, private pattern:PatternsService) {
    this.bankRoutingMinLength = this.pattern.bankroutingNumberMin;
    this.bankRoutingMaxLength = this.pattern.bankroutingNumberMax;
    this.accountNumberMinlength = this.pattern.accountNumberMin;
    this.accountNumberMaxLength = this.pattern.accountnumberMax;
