...
export class QualificationsComponent implements OnInit {
  ...
  institutionLength;
  gpaScoreLength;
  specializationLength;
  minimumLength;
  maximumLength;
  certificateMaxNumber;
  certificateMinNumber;
  ...
  constructor(private route: ActivatedRoute, public http: Http, private router: Router, public auth: AuthenticationService, public service: UserService, private eventEmitterService: EventEmitterService, private pattern: PatternsService) {
    ...
    this.employerLength = this.pattern.companynameLength;
    ...
    this.responsibilitiesLength = this.pattern.responsibilitiesLength;
    this.institutionLength = this.pattern.institutionLength;
    this.gpaScoreLength = this.pattern.gpaScore;
    this.specializationLength = this.pattern.specializationLength;
    this.minimumLength = this.pattern.minimumLength;
    this.maximumLength = this.pattern.maximumLength;
    this.certificateMaxNumber = this.pattern.caertificateNumberMaximum;
    this.certificateMinNumber = this.pattern.certificateNumberMinimum;
