...
export class AddReviewComponent implements OnInit {
  ...
  dateValidate() {
    ...
    if (this.trackerData.startDate >= this.trackerData.endDate) {
      this.dateError = 'Please select valid end date';
    }
    else{
      this.dateError = "";  
    }
    if ((this.trackerData.startDate >= this.trackerData.dueDate) || (this.trackerData.endDate < this.trackerData.dueDate)) {
      this.dateError1 = 'Due date should be between start date and end date';
    }
    else{
      this.dateError1 = "";  
    }
