...
export class AddBranchesComponent implements OnInit {
  ...
  constructor(private http: Http, private router: Router, public service: UserService,public location :Location , private pattern:PatternsService) {
    ...
    this.faxLength = this.pattern.FAXMinimunLength;
    this.faxMaxlength = this.pattern.FAXMinimunLength;
    this.addressLength = this.pattern.addressLength;
    this.streetLength  = this.pattern.streetlength;
    this.zipcodeLength = this.pattern.zipcode;
    this.zipcodeMaxLength = this.pattern.zipcodeMaximum;
