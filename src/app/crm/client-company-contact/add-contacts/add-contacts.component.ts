...
export class AddContactsComponent implements OnInit {
  ...
  checkClientName(){
    ...
    this.companyData.companyName = this.compdata.companyName;
    this.companyData.companyType = "customer";  
  ...
  checkCompanyContactEmail(){
    ...
    this.checkData.companyType = "customer";  
  ...
  checkCompanyEmail(){
    ...
    this.companyInfo.companyType = 'customer'; 
    this.companyInfo.emailId = this.compdata.emailId;  
    this.service.checkCompanyEmail(this.companyInfo)
    .subscribe(res => {
      this.result = res.json();
      if(this.result.statusCode.code === "200"){
        this.companyEmailError = this.result.data;
      }
      else if(this.result.statusCode.code === "404"){
        this.companyEmailError = "";
      }
      else{
        this.companyEmailError = this.result.errorMessages;
      }
    })
  }
  // check company email added by suresh -12-04-2014 start 
