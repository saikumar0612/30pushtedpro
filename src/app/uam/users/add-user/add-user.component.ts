...
export class AddUserComponent implements OnInit {
  ...
  constructor(private http: Http, private router: Router, private blocation: Location, public service: UserService, private patterns:PatternsService) {
    this.nameMaxlength = this.patterns.maxName;
    this.nameMinlength = this.patterns.minName;
    this.emailLength = this.patterns.emaillength;
    this.passwordLength = this.patterns.passwordLength;
