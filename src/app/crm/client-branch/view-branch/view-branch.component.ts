...
export class ViewBranchComponent implements OnInit {
  ...
  parentLogo = '';
  constructor(private eventEmitterService: EventEmitterService, private route: ActivatedRoute, public http: Http, private router: Router, private blocation: Location, private service: UserService) {
