...
export class UploadCandidatedocumentsComponent implements OnInit {
  ...
  maxlength;
  descriptionLength;
  constructor(private service:UserService, private route: ActivatedRoute,private pattern:PatternsService) {
    this.minLength = this.pattern.minimumLength;
    this.maxlength = this.pattern.DocumentTitleMaxLength;
  ...
  deleteDoc(id){
    ...
    this.deletedItems.canId = this.candidateId;
