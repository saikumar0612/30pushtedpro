...
export class CandidateProfileComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    if(this.candidateData.addressLine1){
      this.profileCount=this.profileCount+12.5;
      console.log(this.profileCount);
    }
    if(this.candidateData.education){
      this.profileCount=this.profileCount+12.5;
    }
    if(this.candidateData.experience){
      this.profileCount=this.profileCount+12.5;
      console.log(this.profileCount);
    }
    if(this.candidateData.consent){
      this.profileCount=this.profileCount+12.5;
      console.log(this.profileCount);
    }
    if(this.candidateData.skills){
      this.profileCount=this.profileCount+12.5;
      console.log(this.profileCount);
    }
    if(this.candidateData.image){
      this.profileCount=this.profileCount+12.5;
      console.log(this.profileCount);
    }
    if(this.candidateData.summary){
      this.profileCount=this.profileCount+12.5;
      console.log(this.profileCount);
    }
    if(this.candidateData.resume){
      this.profileCount=this.profileCount+12.5;
      console.log(this.profileCount);
    }
    console.log(this.profileCount);
