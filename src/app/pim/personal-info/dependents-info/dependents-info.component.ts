...
export class DependentsInfoComponent implements OnInit {
  ...
  minLength;
  maxLength;
  constructor(private route: ActivatedRoute, public http: Http, private router: Router, public auth: AuthenticationService, public service: UserService,private eventEmitterService: EventEmitterService, public blocation: Location, private pattern:PatternsService) {
