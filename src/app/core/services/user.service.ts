...
export class UserService {
    ...
    addOrgPerformanceIndicator(kpiData) {
        this.checkTokenValidity();
        return this.http.post(this.restUrl + '/performance/addOrgPerformanceIndicator', kpiData, this.options).pipe(map(data => data));
    }
    ...
    */
    ...
    checkCompanyName(data){
        this.checkTokenValidity();
        return this.http.post(this.restUrl + '/company/checkCompanyName', data, this.options).pipe(map(data => data));
    }
// check company mail and contact email added by suresh on 12-04-2019 start
    checkCompanyEmail(data){
        this.checkTokenValidity();
        return this.http.post(this.restUrl + '/company/checkCompanyEmail', data, this.options).pipe(map(data => data));
    }

    checkCompanyContactEmail(data){
        this.checkTokenValidity();
        return this.http.post(this.restUrl + '/company/checkCompanyContactEmail', data, this.options).pipe(map(data => data));
    }
// check company mail and contact email added by suresh on 12-04-2019 end


    // code for password update - suresh - start
    checkPassword(data){
        this.checkTokenValidity();
        return this.http.post(this.restUrl + '/user/checkPassword', data, this.options).pipe(map(data => data));
    }

    changeUserPassword(data){
        this.checkTokenValidity();
        return this.http.post(this.restUrl + '/user/changeUserPassword', data, this.options).pipe(map(data => data));
    }
    // code for password update - suresh - end

    getAssignedEmployeesofProject(projectId){
        this.checkTokenValidity();
        return this.http.get(this.restUrl + '/project/getAssignedEmployeesofProject?id='+projectId, this.options).pipe(map(data => data));
    }

    updateAssignedEmployees(data){
        this.checkTokenValidity();
        return this.http.post(this.restUrl + '/project/editAssignProject', data, this.options).pipe(map(data => data));
    }
}
