...
export class EditPrerequisiteDocComponent implements OnInit {
  ...
  minLength;
  maxLength;
  constructor(public http: Http, private route: ActivatedRoute, public location: Location, private sanitizer: DomSanitizer,public service :UserService , public authenticationService:AuthenticationService, private router: Router,private eventEmitterService: EventEmitterService, private pattern:PatternsService) {
    this.minLength = this.pattern.minName;
    this.maxLength = this.pattern.maximumLength;

    this.logger.actionPath=this.router.url;
		this.logger.actionTitle='Edit prerequisite document';
		this.logger.comment='Edit prerequisite document';
