...
export class EditUserComponent implements OnInit {
  ...
  nameMaxlength;
  nameMinlength;
  constructor(public http: Http, private route: ActivatedRoute, private router: Router, private blocation: Location, public service: UserService, private patterns:PatternsService) {
